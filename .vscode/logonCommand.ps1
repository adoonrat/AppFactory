...
Start-Process -FilePath "C:\Users\WDAGUtilityAccount\Desktop\Deploy-Application.exe" -Wait
...
Start-Process -FilePath "C:\Users\WDAGUtilityAccount\Desktop\Deploy-Application.exe" -ArgumentList "Uninstall" -Wait

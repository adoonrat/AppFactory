...
$AppName = "7Zip"
Start-Process -FilePath "C:\Users\WDAGUtilityAccount\Desktop\$AppName\Deploy-Application.exe" -Wait
...
Start-Process -FilePath "C:\Users\WDAGUtilityAccount\Desktop\$AppName\Deploy-Application.exe" -ArgumentList "Uninstall" -Wait
